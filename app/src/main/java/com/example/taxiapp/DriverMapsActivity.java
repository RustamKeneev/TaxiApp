...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void signOutDriver() {
        String driverUserId = firebaseUser.getUid();
        DatabaseReference driversDatabaseReference = FirebaseDatabase.getInstance().getReference().child("drivers");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (currentLocation !=null){
            ...
            mMap.addMarker(new MarkerOptions().position(driverLocation).title("местоположение водителя"));
